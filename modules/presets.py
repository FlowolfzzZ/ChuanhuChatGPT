...
CHUANHU_TITLE = i18n("本草")

CHUANHU_DESCRIPTION = i18n("由哈工大SCIR-HI组开发，模型发布：[本草医学大模型](https://github.com/SCIR-HI/Med-ChatGLM)。<br/>特别鸣谢：[川虎GPT](https://github.com/GaiZhenbiao/ChuanhuChatGPT)")
